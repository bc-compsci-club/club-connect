...
const Volunteer = () => (
  <Element name="volunteer">
    <section className="contribute-volunteer" id="volunteer">
      <h2 className="contribute-heading">Volunteer for the Club</h2>
      <p>
      ...
      <h3 className="contribute-open-roles-heading">Open Roles:</h3>
