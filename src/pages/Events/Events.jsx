  ...
  return (
    <div className="Events">
      ...
      <ul className="events-list">
        <li>
          <Link to="/events/1/meet-the-board">Meet the Board: September 10</Link>
        </li>
        <li>
          <Link to="/events/2/donuts-and-discussion">Donuts and Discussion: September 16</Link>
        </li>
        <li>
          <Link to="/events/3/facul-tea-time">Facul-Tea Time: September 22</Link>
        </li>
      </ul>
      ...
      <p>
        ...
        <a href="https://github.com/bc-compsci-club/bccompsci.club">
